...
def add_predict_args(parser: ArgumentParser):
    ...
    parser.add_argument('--data_path', type=str,
                        ...
                        default='../data/matgen_new/preprocess')
    parser.add_argument('--test_path', type=str,
                        help='Path to CSV file containing testing data for which predictions will be made',
                        default='../data/matgen_new/preprocess/experiment_1716')
    parser.add_argument('--dataset_name', type=str,
                        choices=['band_gap', 'total_energy', 'per_atom_energy', 'formation_energy', 'efermi', 'magnetization'],
                        help='Choose a task')
    ...
    parser.add_argument('--max_data_size', type=int, default=float('inf'),
...
def add_train_args(parser: ArgumentParser):
    ...
    :param parser: An ArgumentParser.
    """
    # General arguments use in crystalnet
    parser.add_argument('--gpu', type=int,
                        choices=list(range(torch.cuda.device_count())),
                        help='Which GPU to use')
    parser.add_argument('--seed', type=int, default=0,
    ...
    parser.add_argument('--train_path', type=str,
                        help='Path to CSV file containing testing data for which predictions will be made',
                        default='../data/matgen_new/preprocess/calculate')
    parser.add_argument('--dataset_name', type=str,
                        choices=['band_gap', 'total_energy', 'per_atom_energy', 'formation_energy', 'efermi', 'magnetization'],
                        help='Choose a task')
    ...
    parser.add_argument('--run_fold', type=int, default=0,
                        help='run corresponding fold in prepared split data')
    ...
    # General arguments no use in crystalnet
    ...
    parser.add_argument('--radius', type=int, default=5,
                        help='The crystal neighbor radius')
    parser.add_argument('--rbf_parameters', type=tuple, default=(0, 5, 0.1, 0.5),
                        help='the RBF parameters, (dmin, dmax, step, var)')
    parser.add_argument('--max_num_neighbors', type=int, default=32,
                        help='the maximum of crystal neighbors')
